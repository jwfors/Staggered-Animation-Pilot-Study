...
[<img src="https://img.youtube.com/vi/Cc-OCZAnwFo/hqdefault.jpg" width="700" height="450"
/>](https://www.youtube.com/embed/Cc-OCZAnwFo)
...
[<img src="https://img.youtube.com/vi/XVLwxOZEssg/hqdefault.jpg" width="700" height="450"
/>](https://www.youtube.com/embed/XVLwxOZEssg)
...
# Once finished, what have I learned and what would I change?
There are a lot of problems in the code, but none that stop it from working. If minimal changes were to done to follow up or expand on this project I would keep it as is and add onto it. If, however, this were to be part of a significantly larger project I would rework some of the code. The code makes use of lots of different lists, indexes, positions and whatever else. Through the progress I learned that this was not sustainable long-term and required me to keep attaching new things to the code to make the existing code work.

If I were to rework it I would start by sketching out which parts I need to keep track of and figure out a smart and more concise way to keep all that information stored. Lots of functions operate on different variables all because they need something slightly different for their logic to work. Had I known everything I needed from the start this could've been condensed into a format that more easily allowed me to access everything I needed without cluttering the code. If I were to create something short and simple, it would probably have the same building process. But if I were to do anything needed for a larger scale I would first be sure I knew everything the project would need (such as making rough prototype). I would then sit down and analyze how to best combine and represent data before I actually start to build the real project. 
...
While the use of generative AI within this project was minimal, it was still used from time to time. The answers produced by the LLM were always researched, verified and tested prior to be being accepted.
